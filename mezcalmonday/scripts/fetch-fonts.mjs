// Downloads latin-subset variable woff2 files from Google Fonts for self-hosting. Run: node scripts/fetch-fonts.mjs
import fs from 'node:fs'; import path from 'node:path';
const UA = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/128.0 Safari/537.36';
const families = [
  { q: 'Archivo:ital,wdth,wght@0,62..125,100..900;1,62..125,100..900', name: 'Archivo' },
  { q: 'Geist:wght@100..900', name: 'Geist' },
];
